...
export const ProcedureCards: React.FC = () => {
    ...
    return (
        <section className="max-w-6xl mx-auto mt-10">
            ...
            <h1 className="text-xl md:text-2xl text-center font-bold mt-2">Book a move in three simple steps</h1>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 mt-6">
                <StepCard 
