      ...
      <div className='my-auto section-title h-1/2 w-full z-10 '>
        <main className='container flex flex-col items-center text-center space-y-8'>
         ...
         <p className='w-5/6 sm:w-ful'>Whether moving down the street, to another state, or to
          ...
          <div className="w-5/6 sm:w-full sm:mt-10">
            <form onSubmit={handleSubmit} className='border-[#9d9d9d]/20 bg-[#9d9d9d]/20 border-[15px] lg:border-[10px] rounded-lg lg:rounded-full w-full mx-auto lg:w-[70%] flex space-y-4 sm:space-y-0 flex-col md:flex-row input_shadow'>
              ...
              <button type="submit" className='bg-blue-100 hover:bg-blue-600 hover:animate-pulse p-3  w-full lg:w-[180px] rounded-lg lg:rounded-r-full border-[#9d9d9d]/20 text-gray-500 hover:text-gray-100 border-8 lg:border-none uppercase text-xs font-bold'>
                Get Started
              </button>
            </form>
          </div>
