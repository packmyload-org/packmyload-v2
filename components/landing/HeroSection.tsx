        ...
        <main className='flex flex-col w-full items-center text-center '>
         ...
         <span className='w-[94%] lg:w-[830px] p-2 md:p-0 mx-auto text-sm md:text-lg font-medium leading-5'>Every Move Is Unique and we have the right relocation solution for you. From full service and DIY relocation solutions to vehicle transport services for domestic and international moving.</span>
          ...
          <div className="flex flex-wrap w-full justify-center gao-2 lg:gap-6 mt-2 mx-auto">
            <img src="/images/team/hero-img1.jpg" alt="Image 1" className='w-[80px] h-[80px] md:w-[160px] md:h-[160px] lg:w-[220px] lg:h-[220px] object-contain' />
            ...
            <img src="/images/team/hero-img3.jpg" alt="Image 3" className='w-[80px] h-[80px] md:w-[160px] md:h-[160px] lg:w-[220px] lg:h-[220px] object-contain' />
            <img src="/images/team/hero-img4.jpg" alt="Image 4" className='w-[80px] h-[80px] md:w-[160px] md:h-[160px] lg:w-[220px] lg:h-[220px] object-contain' />
            <img src="/images/team/hero-img5.jpg" alt="Image 5" className='w-[80px] h-[80px] md:w-[160px] md:h-[160px] lg:w-[220px] lg:h-[220px] object-contain' />
        </div>
      </div>
    </section>
  )
