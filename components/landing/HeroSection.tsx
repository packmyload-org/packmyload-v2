...
export default function HeroSection() {
    ...
    return (
    <section className={`w-full h-[80vh] sm:h-[80vh] pb-4 md:pb-0 md:h-[90vh] xl:h-[550px] relative flex flex-col justify-center bg-contain bg-[url('/images/hero-img.jpg')]`}>
