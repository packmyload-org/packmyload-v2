         ...
         <p>Whether moving down the street, to another state, or to
          ...
          <div className="sm:w-full sm:mt-10 ">
            <form action="" className='border-[#9d9d9d] bg-[#9d9d9d] border-[15px] lg:border-[10px] rounded-lg lg:rounded-full w-full mx-auto lg:w-[70%] flex space-y-4 sm:space-y-0 flex-col md:flex-row input_shadow'>
              ...
              <button type="button" className='bg-blue-100 hover:bg-blue-600 hover:animate-pulse p-3  w-full lg:w-[150px] rounded-lg lg:rounded-r-full border-[#9d9d9d] text-gray-500 hover:text-gray-100 border-8 lg:border-none uppercase text-xs font-bold'>
                Get Started
              </button>
            </form>
          </div>
