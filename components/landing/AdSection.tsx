        ...
        >
            ...
            >
                ...
                <section className="w-[100%] md:w-[50%] p-4 mt-0 md:mt-11 text-center md:text-left">
                    ...
                    <button className="mt-8 flex justify-evenly mx-auto md:mx-0 items-center hover:animate-pulse w-[180px] p-[8px] border-inherit/20 border-[6px] bg-blue-100 hover:bg-blue-600 hover:text-gray-100 text-white font-bold rounded-full text-xs">
