...
export default function SeemlessExperience() {
  return (
   <section className='w-full flex flex-col text-center text-black hidden sm:hidden lg:block'>
    ...
    <div className='max-w-6xl mx-auto md:grid gap-4 md:gap-10 mt-10 lg:grid-cols-3 items-center p-2 sm:px-2 space-y-10'>
     {/* Card Section  */}
        {/* {
        ...
        <Col span={20} lg={6} className='min-w-[350px]   text-center mx-auto section-title gap-4'>
        ...
        <Col span={20} lg={6} className='min-w-[350px] mx-auto text-center section-title gap-4'>
