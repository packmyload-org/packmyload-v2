...
export const RoomCounter: React.FC<RoomProps> = ({ roomType, price}) => {
    ...
    const counterButtons = (
      ...
      return (
        <div className="bg-blue-200 flex justify-center gap-1 items-center rounded-md shadow-md p-3 w-[80%] h-[90px] sm:w-full mx-auto lg:w-[210px] min-w-[140px]">
          <p className="text-[14px] w-full" title={roomType}>{roomType}</p>
          {counterButtons}
        </div>
      );
}