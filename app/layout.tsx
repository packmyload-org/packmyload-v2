  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" href='/images/bg/shapes-big-new.webp' as="image" />
        <link rel="icon" type='image/png' href="/favicon.ico" />

        {/* Meta tags */}
        <meta charSet="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="description" content="Packmyload is Nigeria's #1 packing and moving company in Lagos and Abuja, offering international and interstate moving services." />
        ...
        <meta property="og:title" content="Packmyload - Moving and Packing Services" />
        ...
        <meta name="twitter:image" content="https://www.packmyload.com/images/iconpackmyload.webp" />

        {/* WhatsApp Meta tags */}
        <meta property="og:site_name" content="Packmyload" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:see_also" content="https://www.packmyload.com" />

        {/* Canonical tag for SEO */}
        <link rel="canonical" href="https://www.packmyload.com/gallery?page=1&size=9" />
