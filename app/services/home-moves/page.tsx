...
export default function HomeMoves(){
    ...
    return (
        <main className='bg-[#F9F9F9]'>
            <div className="w-full h-[300px] mt-[68px] bg-[url('/images/moving-company-lagos-nigeria-packmyload.com-home_moves-banner_image.png')]" style={divStyle}>
            ...
            <div className="mx-auto mt-8 flex flex-col items-center" ref={content}>
                ...
                >Home Relocation within Nigeria</div>
                <div className="md:text-3xl text-xl text-[#566985] mt-4 font-bold" style={{ position: 'relative' }}>Home Relocation within Nigeria</div>
