...
import NotFoundImage from "@/public/images/iconpackmyload.png"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-400" data-aos="fade-up" data-aos-delay="400">Head to our <Link href="/" className="text-purple-600 hover:text-black transition duration-150 ease-in-out">homepage</Link> that does exist, or try double-checking the URL.</p>
            </div>
          </div>
        </div>
      </section>
