      ...
      <div className="w-full text-black" style={{ marginTop: "70px" }}>
        ...
        <div className="w-full bg-[#012D40] h-auto py-20">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-5 lg:flex-row justify-between max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row mt-4 pb-8 justify-between gap-5 md:shrink-0 max-w-6xl mx-auto">
              <div className="lg:pt-40 w-[100%] md:w-[90%] px-2 mx-auto lg:mx-0">
