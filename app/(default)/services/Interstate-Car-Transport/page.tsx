    ...
    return (
          ...
          <div className="relative bottom-10 flex flex-col gap-4 bg-[#EDF2F8] py-2">
            <div className="flex flex-col gap-5 md:flex-row justify-between max-w-6xl mx-auto">
              ...
              <div className=" w-[90%] flex flex-col justify-center ">
                <h2 className="text-2xl font-semibold w-full py-2 md:w-8/12  mt-4 px-2 lg:px-0 mx-auto text-[#566985]">
                  {" "}
                  Trusted Long Distance Moving Company
                </h2>
                <p className=" w-full text-sm  md:w-8/12  mt-4 px-2 lg:px-0 mx-auto text-[#878C9F]">
            ...
            <div className="flex flex-col gap-5 py-4 md:flex-row justify-between max-w-6xl mx-auto">
              <div className=" w-[90%] flex flex-col justify-center ">
                <h2 className="text-2xl font-semibold w-full  md:w-8/12  mt-4 px-2 lg:px-0 mx-auto text-[#566985]">
                  {" "}
                ...
                <div>
                  <div className="">
                    <div className="grid grid-rows-2  md:grid-cols-2 lg:grid-cols-3 gap-3 py-6 ">
                    ...
                    <section className='flex gap-2 items-start mt-4'>
                        ...
                        />
                        <div>
                            <h1 className='text-lg text-[#4DB7FE] font-bold'>Packing and Unpacking </h1>
                    ...
                    <section className='flex gap-2 items-start mt-12'>
                        ...
                        />
                        <div>
                            <h1 className='text-lg text-[#4DB7FE] font-bold'>Storage Services </h1>
        ...
        <div className="w-full h-auto">
          ...
          <div>
            ...
            <section>
                <div className='flex flex-col mx-auto items-center justify-end h-full bg-[#4DB7FE]  py-3 my-7 ' >
                  <h1 className='text-2xl font-bold text-[#ffff] pt-5 '>Request A Interstate Moving Quote</h1>

                  <button  className="text-white shadow-lg border-2 text-xl font-bold p-2 w-[200px] bg-[#4BCBFE] outline-none transition-colors duration-600 hover:animate-pulse hover:bg-white hover:text-black my-5">Get Quote</button>
